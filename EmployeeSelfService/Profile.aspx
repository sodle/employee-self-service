<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="EmployeeSelfService.Profile" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            Employee ID&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="EmployeeID" runat="server" Enabled="false" TextMode="Number"></asp:TextBox>
            <br />
            First name&nbsp;&nbsp;&nbsp;
            ...
            <br />
            Email address&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Email" runat="server" TextMode="Email" Enabled="False"></asp:TextBox>
            <br />
            Username&nbsp;&nbsp;&nbsp; <asp:TextBox ID="Username" runat="server" Enabled="False"></asp:TextBox>
            <br />
            Street address<br />
